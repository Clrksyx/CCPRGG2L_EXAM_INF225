...
public class Regex {
     public static void main(String[] args) throws Exception {
        ...
        pattern = Pattern.compile("(?=)[^\\d$][^PVNTpvnt].{6,}");
        ...
        pattern = Pattern.compile("^(?=.*39).{10,15}@(gmail||ymail)\\.com$");
        ...
        tweet = "Press On, three, was killed training this morning at Santa Anita - â€œmusculoskeletal,â€ for now. He is the sixth dead horse at Cal tracks through the first three weeks of 2023. â€œReformâ€ is a ruse, â€œsafe racingâ€ a lie. Horseracing kills; it must end.";
